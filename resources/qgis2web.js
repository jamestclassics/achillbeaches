...
map.getView().fit([-1144928.769349, 7146298.251477, -1092563.067398, 7176433.230902], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Achill Beaches</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (21 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Beaches James Treanor';
            }
